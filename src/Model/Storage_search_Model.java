...
public class Storage_search_Model extends AbstractTableModel {
    private String[] columnNames = { "入库时间", "图书名称","图书种类","出版社","图书条码","库存量","单价"};
    private Object[][] data;
    public Storage_search_Model(ArrayList<Book_Information> book_informations)
    {
