...
public class In_Storage_Table_Model extends AbstractTableModel {
    private String[] columnNames = { "图书名称", "出版社","图书条码","库存量","分类","单价","入库时间"};
    private Object[][] data;
    public In_Storage_Table_Model(ArrayList<Book_Information> book_informations)
    {
